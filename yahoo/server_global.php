...
//this is for testing the file, and server methods and their keys
...
<!-- the file server receive.php will handle this file -->
<form action="server_receive.php" method="post">
